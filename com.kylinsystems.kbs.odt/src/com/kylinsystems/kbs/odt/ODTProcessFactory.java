/******************************************************************************
 * Copyright (C) 2019 ken.longnan@gmail.com                                   *
...
/**
 * KSYS process factory implementation.
 */
public class ODTProcessFactory implements IProcessFactory {

	private final static CLogger log = CLogger.getCLogger(ODTProcessFactory.class);

	/**
	 * default constructor
	 */
	public ODTProcessFactory() {
	}
	...
	public ProcessCall newProcessInstance(String className) {
		...
		if (className.startsWith("com.kylinsystems.kbs.odt.process"))
		{
